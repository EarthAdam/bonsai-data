...
public class DrawLine3 : MonoBehaviour {
	...
	void Start () {
		points[0] = new Vector3(-0.2f,0,0);
		points[1] = new Vector3(-0.2f,3,0);
		points[2] = new Vector3(-1,4,0);
		points[3] = new Vector3(-1.4f,6,0.51f);
