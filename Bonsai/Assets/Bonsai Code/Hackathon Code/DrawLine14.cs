...
public class DrawLine14 : MonoBehaviour {
	...
	void Start () {
		points[0] = new Vector3(0,0,0.1f);
		points[1] = new Vector3(0,3,0.1f);
		points[2] = new Vector3(0,3.6f,2);
		points[3] = new Vector3(0f,3.6f,3.51f);
