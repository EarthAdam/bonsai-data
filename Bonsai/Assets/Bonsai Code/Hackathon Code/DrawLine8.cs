...
public class DrawLine8 : MonoBehaviour {
	...
	void Start () {
		points[0] = new Vector3(-0.18f,0,0);
		points[1] = new Vector3(-0.18f,3,0);
		points[2] = new Vector3(-1.08f,4,0.5f);
		points[3] = new Vector3(-1.3f,6,0.91f);
