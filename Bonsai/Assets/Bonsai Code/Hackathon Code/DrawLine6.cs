...
public class DrawLine6 : MonoBehaviour {
	...
	void Start () {
		points[0] = new Vector3(0.2f,0,0.15f);
		points[1] = new Vector3(0.2f,3,0.15f);
		points[2] = new Vector3(2,5,1);
		points[3] = new Vector3(3f,7,0.51f);
