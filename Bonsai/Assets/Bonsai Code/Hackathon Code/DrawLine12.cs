...
public class DrawLine12 : MonoBehaviour {
	...
	void Start () {
		points[0] = new Vector3(0.29f,0,0.1f);
		points[1] = new Vector3(0.29f,3,0.1f);
		points[2] = new Vector3(1.1f,4,2);
		points[3] = new Vector3(1.4f,3,3.51f);
